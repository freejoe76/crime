...
neighborhood_lookup = {
    'athmar-park': {'full': 'Athmar Park', 'nearest_neighbors': {'valverde', 'baker', 'ruby-hill', 'westwood'}, 'location': {}, 'population': 0},
    ...
    'barnum': {'full': 'Barnum', 'nearest_neighbors': {'villa-park', 'barnum-west', 'valverde', 'westwood'}, 'location': {}, 'population': 0},
    'barnum-west': {'full': 'Barnum West', 'nearest_neighbors': {'villa-park', 'barnum', 'westwood'}, 'location': {}, 'population': 0},
    'bear-valley': {'full': 'Bear Valley', 'nearest_neighbors': {'harvey-park-south', 'fort-logan'}, 'location': {}, 'population': 0},
    'belcaro': {'full': 'Belcaro', 'nearest_neighbors': {'washington-park', 'cherry-creek', 'cory-merrill'}, 'location': {}, 'population': 0},
    ...
    'college-view-south-platte': {'full': 'College View South Platte', 'nearest_neighbors': {'harvey-park-south', 'harvey-park', 'ruby-hill', 'overland'}, 'location': {}, 'population': 0},
    ...
    'cory-merrill': {'full': 'Cory Merrill', 'nearest_neighbors': {'washington-park', 'belcaro', 'virginia-village', 'university-park'}, 'location': {}, 'population': 0},
    ...
    'fort-logan': {'full': 'Fort Logan', 'nearest_neighbors': {'bear-valley', 'harvey-park-south', 'marston'}, 'location': {}, 'population': 0},
    ...
    'hampden-south': {'full': 'Hampden South', 'nearest_neighbors': {'southmoor-park', 'hampden'}, 'location': {}, 'population': 0},
    'harvey-park': {'full': 'Harvey Park', 'nearest_neighbors': {'mar-lee', 'college-view-south-platte', 'harvey-park-south'}, 'location': {}, 'population': 0},
    'harvey-park-south': {'full': 'Harvey Park South', 'nearest_neighbors': {'harvey-park', 'college-view-south-platte', 'bear-valley', 'fort-logan'}, 'location': {}, 'population': 0},
    ...
    'mar-lee': {'full': 'Mar Lee', 'nearest_neighbors': {'westwood', 'ruby-hill', 'harvey-park'}, 'location': {}, 'population': 0},
    'marston': {'full': 'Marston', 'nearest_neighbors': {'fort-logan'}, 'location': {}, 'population': 0},
    'montbello': {'full': 'Montbello', 'nearest_neighbors': {'stapleton', 'gateway-green-valley-ranch'}, 'location': {}, 'population': 0},
    'montclair': {'full': 'Montclair', 'nearest_neighbors': {'hale', 'south-park-hill', 'east-colfax', 'lowry-field', 'hilltop'}, 'location': {}, 'population': 0},
    ...
    'overland': {'full': 'Overland', 'nearest_neighbors': {'baker', 'platt-park', 'rosedale', 'college-view-south-platte', 'ruby-hill'}, 'location': {}, 'population': 0},
    ...
    'rosedale': {'full': 'Rosedale', 'nearest_neighbors': {'overland', 'platt-park', 'university'}, 'location': {}, 'population': 0},
    'ruby-hill': {'full': 'Ruby Hill', 'nearest_neighbors': {'athmar-park', 'overland', 'college-view-south-platte', 'mar-lee'}, 'location': {}, 'population': 0},
    ...
    'southmoor-park': {'full': 'Southmoor Park', 'nearest_neighbors': {'university-hills', 'hampden-south'}, 'location': {}, 'population': 0},
    ...
    'union-station': {'full': 'Union Station', 'nearest_neighbors': {'highland', 'five-points', 'cbd', 'auraria'}, 'location': {}, 'population': 0},
    'university': {'full': 'University', 'nearest_neighbors': {'rosedale', 'platt-park', 'washington-park', 'university-park', 'wellshire'}, 'location': {}, 'population': 0},
    'university-hills': {'full': 'University Hills', 'nearest_neighbors': {'university-park', 'wellshire', 'southmoor-park', 'hampden', 'goldsmith'}, 'location': {}, 'population': 0},
    'university-park': {'full': 'University Park', 'nearest_neighbors': {'university', 'wellshire', 'cory-merrill', 'university-hills'}, 'location': {}, 'population': 0},
    'valverde': {'full': 'Valverde', 'nearest_neighbors': {'sun-valley', 'baker', 'athmar-park', 'barnum'}, 'location': {}, 'population': 0},
    ...
    'washington-park': {'full': 'Washington Park', 'nearest_neighbors': {'washington-park-west', 'speer', 'country-club', 'belcaro', 'cory-merrill', 'university'}, 'location': {}, 'population': 0},
    'washington-park-west': {'full': 'Washington Park West', 'nearest_neighbors': {'baker', 'washington-park', 'speer', 'platt-park'}, 'location': {}, 'population': 0},
    ...
    'wellshire': {'full': 'Wellshire', 'nearest_neighbors': {'university', 'university-park', 'university-hills', }, 'location': {}, 'population': 0},
    ...
    'westwood': {'full': 'Westwood', 'nearest_neighbors': {'barnum-west', 'barnum', 'athmar-park', 'mar-lee'}, 'location': {}, 'population': 0},
