...
neighborhood_lookup = {
    ...
    'capitol-hill': {'full': 'Capitol Hill', 'adjacent-neighbors': {}, 'nearest_neighbors': {'north-capitol-hill', 'civic-center', 'cheesman-park', 'speer', 'country-club'}, 'location': {}, 'population': 0},
    'cbd': {'full': 'CBD', 'adjacent-neighbors': {}, 'nearest_neighbors': {'auraria', 'union-station', 'five-points', 'north-capitol-hill', 'civic-center'}, 'location': {}, 'population': 0},
    ...
    'cheesman-park': {'full': 'Cheesman Park', 'adjacent-neighbors': {}, 'nearest_neighbors': {'capitol-hill', 'city-park-west', 'congress-park', 'country-club'}, 'location': {}, 'population': 0},
    ...
    'city-park': {'full': 'City Park', 'adjacent-neighbors': {}, 'nearest_neighbors': {'congress-park', 'city-park-west', 'skyland', 'south-park-hill'}, 'location': {}, 'population': 0},
    'city-park-west': {'full': 'City Park West', 'adjacent-neighbors': {}, 'nearest_neighbors': {'north-capitol-hill', 'five-points', 'whittier', 'city-park', 'cheesman-park'}, 'location': {}, 'population': 0},
    'civic-center': {'full': 'Civic Center', 'adjacent-neighbors': {}, 'nearest_neighbors': {'cbd', 'capitol-hill', 'lincoln-park'}, 'location': {}, 'population': 0},
    ...
    'congress-park': {'full': 'Congress Park', 'adjacent-neighbors': {}, 'nearest_neighbors': {'cheesman-park', 'city-park', 'hale', 'cherry-creek', 'country-club'}, 'location': {}, 'population': 0},
    ...
    'highland': {'full': 'Highland', 'adjacent-neighbors': {'auraria', 'berkeley'}, 'nearest_neighbors': {'sunnyside', 'west-highland', 'jefferson-park', 'union-station', 'five-points', 'globeville'}, 'location': {}, 'population': 0},
    ...
    'north-capitol-hill': {'full': 'North Capitol Hill', 'adjacent-neighbors': {}, 'nearest_neighbors': {'capitol-hill', 'cbd', 'five-points', 'city-park-west', }, 'location': {}, 'population': 0},
    ...
    'sloan-lake': {'full': 'Sloan Lake', 'adjacent-neighbors': {}, 'nearest_neighbors': {'west-highland', 'jefferson-park', 'west-colfax'}, 'location': {}, 'population': 0},
    ...
    'sun-valley': {'full': 'Sun Valley', 'adjacent-neighbors': {}, 'nearest_neighbors': {'villa-park', 'west-colfax', 'jefferson-park', 'auraria', 'lincoln-park', 'valverde'}, 'location': {}, 'population': 0},
    'union-station': {'full': 'Union Station', 'adjacent-neighbors': {}, 'nearest_neighbors': {'highland', 'five-points', 'cbd', 'auraria'}, 'location': {}, 'population': 0},
    ...
    'villa-park': {'full': 'Villa Park', 'adjacent-neighbors': {}, 'nearest_neighbors': {'west-colfax', 'sun-valley', 'barnum-west', 'barnum'}, 'location': {}, 'population': 0},
    ...
    'west-colfax': {'full': 'West Colfax', 'adjacent-neighbors': {}, 'nearest_neighbors': {'sloan-lake', 'sun-valley', 'villa-park'}, 'location': {}, 'population': 0},
