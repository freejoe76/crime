...
declare -a HOODS=('highland' 'country-club' 'speer' 'cherry-creek' 'city-park' 'city-park-west' 'five-points' 'cole' 'north-park-hill' 'south-park-hill' 'platt-park' 'capitol-hill' 'north-capitol-hill' 'civic-center' 'lincoln-park' 'cheesman-park' 'congress-park' 'cbd' 'five-points' 'whittier' 'union-station' 'auraria' 'baker' 'hale' 'clayton')
